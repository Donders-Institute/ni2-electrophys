...
figure;plot(source_noise.time,source_noise.avg.mom{2352});legend({'x' 'y' 'z'});
figure;plot(source_noise.time,source_noise.avg.mom{2342});legend({'x' 'y' 'z'});
figure;plot(source_noise.time,source_noise.avg.mom{2347});legend({'x' 'y' 'z'});
figure;plot(source_noise.time,source_noise.avg.mom{2713});legend({'x' 'y' 'z'});
